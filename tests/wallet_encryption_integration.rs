...
mod wallet_encryption_tests {
    ...
    fn test_validate_encrypted_wallet_with_kdf_params() {
        ...
        let encrypted_bundle = "YWJjZGVmZ2hpamtsbW5vcA==:cXdlcnR5dWlvcGFzZGZnaA==:aGprbGFzZGZnaGprbGFzZGY=:32768:4";
    ...
    fn test_validate_legacy_encrypted_wallet() {
        ...
        let encrypted_bundle = "YWJjZGVmZ2hpamtsbW5vcA==:cXdlcnR5dWlvcGFzZGZnaA==:aGprbGFzZGZnaGprbGFzZGY=";
    ...
    fn test_wallet_rotation_with_kdf_options() {
        ...
        assert!(result.is_some(), "KDF options should be Some when mem/iterations are set");
    }
    ...
    fn test_wallet_rotation_with_default_kdf() {
        ...
        assert!(result.is_none(), "KDF options should be None when both are unset");
    }
    ...
    fn test_reject_invalid_kdf_parameters() {
        ...
        assert!(iterations_result.is_err(), "Invalid iterations should fail to parse");
    }
    ...
    fn test_wallet_secret_storage_formats() {
        ...
        let encrypted_secret = "YWJjZGVmZ2hpamtsbW5vcA==:cXdlcnR5dWlvcGFzZGZnaA==:aGprbGFzZGZnaGprbGFzZGY=";
        assert!(encrypted_secret.contains(':'));
        
        // Both formats should be distinguishable
        assert_ne!(plaintext_secret.contains(':'), encrypted_secret.contains(':'));
    }
    ...
    fn test_wallet_rotation_history() {
        ...
        let rotation = WalletRotationRecord {
            ...
            previous_public_key: "GXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX".to_string(),
